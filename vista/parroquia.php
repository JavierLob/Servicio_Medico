<script>
    function buscar(id)
    {
        window.location.href="?vista=consultar_parroquia&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=registrar_parroquia"><i class="fa fa-plus"></i> Registrar parroquia</a>
