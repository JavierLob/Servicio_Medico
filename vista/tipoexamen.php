<script>
    function buscar(id)
    {
        window.location.href="?vista=consultar_tipoexamen&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=registrar_tipoexamen"><i class="fa fa-plus"></i> Registrar tipo examen</a>
