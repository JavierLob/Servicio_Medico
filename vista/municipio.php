<script>
    function buscar(id)
    {
        window.location.href="?vista=consultar_municipio&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=registrar_municipio"><i class="fa fa-plus"></i> Registrar municipio</a>
