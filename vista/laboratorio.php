<script>
    function buscar(id)
    {
        window.location.href="?vista=consultar_laboratorio&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=registrar_laboratorio"><i class="fa fa-plus"></i> Registrar Laboratorio</a>
