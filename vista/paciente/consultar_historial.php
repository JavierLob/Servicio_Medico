    ...
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          <i class="fa fa-wheelchair fa-2x"></i> Datos Paciente
        </a>
      </h4>
    </div>
          ...
          <div class="row">
              <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input readOnly value="00-000<?php print($laPaciente['idpaciente']); ?>" type="text" name="numerohistoria" maxlength="11" class="form-control solo-numeros" id="cam_numerohistoria" disabled>
                  </div>
              </div>
              <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <select name="nacionalidad" id="cam_nacionalidad" class="form-control" disabled>
              ...
              <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <select name="documento" id="cam_documento" class="form-control" disabled>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="cedulaopasaporte" maxlength="11" value="<?php print($laPaciente['cedulaopasaporte']); ?>" class="form-control solo-numeros" id="cam_cedulaopasaporte" disabled>
                  </div>
              </div>
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="primernombre" maxlength="455" value="<?php print($laPaciente['primernombre']); ?>" class="form-control letras_latinas" id="cam_primernombre" disabled>
                  </div>
              </div>
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="segundonombre" maxlength="45" value="<?php print($laPaciente['segundonombre']); ?>" class="form-control letras_latinas" id="cam_segundonombre" disabled>
                  </div>
              </div>
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="primerapellido" maxlength="45" value="<?php print($laPaciente['primerapellido']); ?>" class="form-control letras_latinas" id="cam_primerapellido" disabled>
                  </div>
              </div>
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="segundoapellido" maxlength="45" value="<?php print($laPaciente['segundoapellido']); ?>" class="form-control letras_latinas" id="cam_segundoapellido" disabled>
                  </div>
              </div>
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="sexo" id="cam_sexo" class="form-control" disabled>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="telefono" maxlength="15" value="<?php print($laPaciente['telefono']); ?>" class="form-control solo-numeros" id="cam_telefono" disabled>
                  </div>
              </div>
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="celular" maxlength="15" value="<?php print($laPaciente['celular']); ?>" class="form-control solo-numeros" id="cam_celular" disabled>
                  </div>
              </div>
            </div>
          </div>
        ...
        <div class="panel-heading" role="tab" id="headingTwo">
          <h4 class="panel-title">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
              <i class="fa fa-th fa-2x"></i> Otros Datos (Dirección - Antecedentes)
            </a>
          </h4>
        </div>
              ...
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea name="direccion" maxlength="1000" class="form-control letras_numeros" id="cam_direccion" disabled><?php print($laPaciente['direccion']); ?></textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea name="antecedentepersonal" maxlength="1000"  class="form-control letras_numeros" id="cam_antecedentepersonal" disabled><?php print($laPaciente['antecedentepersonal']); ?></textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea name="antecedentefamiliar" maxlength="1000" class="form-control letras_numeros" id="cam_antecedentefamiliar" disabled><?php print($laPaciente['antecedentefamiliar']); ?></textarea>
                    </div>
                </div>
              </div>
            </div>
          ...
          <div class="panel-heading" role="tab" id="headingThree">
            <h4 class="panel-title">
              <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                <i class="fa fa-graduation-cap fa-2x"></i> Datos Académicos
              </a>
            </h4>
          </div>
            ...
            <div class="panel-body">
              ...
              <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select name="estado" id="cam_estado" class="form-control" disabled>
                          <option value="">-</option>
                          <?php
              ...
              <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <select name="municipio" id="cam_municipio" class="form-control" disabled>
                          <option value="">-</option>
                          <?php
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="idparroquia" class="form-control" id="cam_idparroquia" disabled>
                        <option value="">-</option>
                        <?php
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="idtsede" class="form-control" id="cam_idtsede" disabled>
                        <option value="">-</option>
                        <?php
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="idtetnia" class="form-control" id="cam_idtetnia" disabled>
                        <option value="">-</option>
                        <?php
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="idttipopaciente" class="form-control" id="cam_idttipopaciente" disabled>
                        <option value="">-</option>
                        <?php
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="tcarrera_idtcarrera" class="form-control" id="cam_tcarrera_idtcarrera" disabled>
                        <option value="">-</option>
                        <?php
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="tdepartamento_iddepartamento" class="form-control" id="cam_tdepartamento_iddepartamento" disabled>
                        <option value="">-</option>
                        <?php
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="modalidadpac" class="form-control" id="cam_modalidadpac" disabled>
                        <option value="">-</option>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="numeromodalidadpac" class="form-control" id="cam_numeromodalidadpac" disabled>
                        <option value="">-</option>
    ...
    <div class="panel panel-default">
          <div class="panel-heading" role="tab" id="headingFour">
            <h4 class="panel-title">
              <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                <i class="fa fa-heartbeat fa-2x"></i> Otros Datos (Alergias, discapacidades y enfermedades)
              </a>
            </h4>
          </div>
              ...
              <div class="row">
                <div class="col-md-4">
                   <label for="cam_alergico">¿Alergico? <strong><i class="text-help fa fa-question-circle" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Seleccione si es alergico o no."></i></strong></label>
                      ...
                      <select class="form-control" id="cam_alergico" disabled>
                        <option value=""></option>
                ...
                <div class="col-md-4">
                   <label for="cam_consulta">¿Discapacidades? <strong><i class="text-help fa fa-question-circle" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Seleccione si padece de alguna discapacidad."></i></strong></label>
                      ...
                      <select class="form-control" id="cam_discapacidades"disabled>
                        <option value=""></option>
                ...
                <div class="col-md-4">
                   <label for="cam_consulta">¿Enfermedad Crónica? <strong><i class="text-help fa fa-question-circle" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Seleccione si padece de alguna enfermedad cronica."></i></strong></label>
                      ...
                      <select class="form-control" id="cam_cronico"disabled>
                        <option value=""></option>
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <table class="table table-striped" id="alergia">
                    ...
                    ?>
                      <tr>
                        <td>
                          <select class="form-control" name="idalergia[]" onchange="validar_repetido_alergia(this)" id="cam_idalergia<?php print($j);?>" disabled>
                            <option value=""></option>
                            <?php
                    ...
                    <tbody id="filas_discapacidad">
                     <?php
                      ...
                      ?>
                        <tr>
                        <td>
                          <select class="form-control" name="idtdiscapacidad[]" onchange="validar_repetido_discapacidad(this)" id="cam_discapacidad<?php print($j);?>"disabled>
                            <option value=""></option>
                            <?php
                  ...
                  <table class="table table-striped" id="enfermedad">
                    ...
                    <?php
                      ...
                      ?>
                        <tr>
                        <td>
                          <select class="form-control" name="idtenfermedadescronicas[]" onchange="validar_repetido_enfermedad(this)" id="cam_enfermedad<?php print($j);?>"disabled>
                            <option value=""></option>
                            <?php
                ...
                <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea name="observacion" maxlength="1000" class="form-control letras_numeros" id="cam_observacion" disabled><?php print($laPaciente['observacion']); ?></textarea>
                      </div>
                </div>
              </div>
            </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading" role="tab" id="headingSix">
            <h4 class="panel-title">
              <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                <i class="fa fa-medkit fa-2x"></i> Consultas
              </a>
            </h4>
          </div>
          <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
            <div class="panel-body">  
              <div class="row">
                  <table class="table table-striped table-hover table-resposive" id="filtro">
                      <thead>
                    ...
                    <?php
                            ...
                            $laconsulta=$lobjConsulta->consultas_paciente();
