<script>
    function buscar(id)
    {
        window.location.href="?vista=consultar_centroasistencial&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=registrar_centroasistencial"><i class="fa fa-plus"></i> Registrar centro asistencial</a>
