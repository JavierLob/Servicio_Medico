              ...
              <select name="idttipopersonal" class="form-control" id="cam_idttipopersonal" required>
                  ...
                  <?php
                    ...
                    for ($i=0; $i <count($laTipopersonal) ; $i++) { 
                      $selected = ($lapersonal['ttipopersonal_idtipo_personal']==$laTipopersonal[$i]['idtipopersonal']) ? 'SELECTED' :"";
                      echo '<option '.$selected.' value="'.$laTipopersonal[$i]['idtipopersonal'].'">'.$laTipopersonal[$i]['tipopersonal'].'</option>';                    
                    }
                  ?>
              </select>
            </div>
              ...
              <select name="idrol" class="form-control" id="cam_idrol" required>
                  ...
                  <?php
                    ...
                    for ($i=0; $i <count($laRol) ; $i++) { 
                      $selected = ($lapersonal['trol_idrol']==$laRol[$i][0]) ? 'SELECTED' :"";
                      echo '<option '.$selected.' value="'.$laRol[$i][0].'">'.$laRol[$i][1].'</option>';                    
                    }
                  ?>
              </select>
            </div>
