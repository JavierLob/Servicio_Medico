<script>
    function buscar(id)
    {
        window.location.href="?vista=configuracion/consultar_departamento&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=configuracion/registrar_departamento"><i class="fa fa-plus"></i> Registrar Departamento</a>
