<script>
    function buscar(id)
    {
        window.location.href="?vista=configuracion/consultar_discapacidad&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=configuracion/registrar_discapacidad"><i class="fa fa-plus"></i> Registrar discapacidad</a>
