<script>
    function buscar(id)
    {
        window.location.href="?vista=configuracion/consultar_etnia&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=configuracion/registrar_etnia"><i class="fa fa-plus"></i> Registrar Etnia</a>
