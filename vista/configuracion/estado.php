<script>
    function buscar(id)
    {
        window.location.href="?vista=configuracion/consultar_estado&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=configuracion/registrar_estado"><i class="fa fa-plus"></i> Registrar estado</a>
