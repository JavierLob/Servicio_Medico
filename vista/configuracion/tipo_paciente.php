<script>
    function buscar(id)
    {
        window.location.href="?vista=configuracion/consultar_tipo_paciente&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=configuracion/registrar_tipo_paciente"><i class="fa fa-plus"></i> Registrar Tipo Paciente</a>
