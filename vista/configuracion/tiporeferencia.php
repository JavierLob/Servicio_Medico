<script>
    function buscar(id)
    {
        window.location.href="?vista=configuracion/consultar_tiporeferencia&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=configuracion/registrar_tiporeferencia"><i class="fa fa-plus"></i> Registrar tipo referencia</a>
