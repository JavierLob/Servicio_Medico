<script>
    function buscar(id)
    {
        window.location.href="?vista=configuracion/consultar_sede&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=configuracion/registrar_sede"><i class="fa fa-plus"></i> Registrar Sede</a>
