<script>
    function buscar(id)
    {
        window.location.href="?vista=consultar_carrera&id="+id;
    }
...
<!-- FIN: RECOMENDACION -->
<a class="btn btn-success" id="btn_registrar" href="?vista=registrar_carrera"><i class="fa fa-plus"></i> Registrar carrera</a>
