<?php
   ...
   */
   ...
   $laconsulta=$lobjConsulta->consultar_referir_reporte($id);
   ob_end_clean();
   ...
   $lobjPdf->Cell(0,6,utf8_decode("REFERENCIA"),0,1,"C");
   $lobjPdf->Ln(10);
   $lobjPdf->SetX(120);
   ...
   $lobjPdf->SetFont("arial","B",10);
   $lobjPdf->Cell(45,6,utf8_decode("Referido al servicio de: "),0,0,"L");
   $lobjPdf->SetFont("arial","",10);
   $lobjPdf->Cell(145,6,utf8_decode($laconsulta['tiporeferencia']),'B',1,"L");
   $lobjPdf->SetFont("arial","B",10);
   $lobjPdf->Cell(45,6,utf8_decode("Referido a: "),0,0,"L");
   $lobjPdf->SetFont("arial","",10);
   $lobjPdf->Cell(145,6,utf8_decode($laconsulta['referidoa']),'B',1,"L");
    $lobjPdf->SetFont("arial","B",10);
   $lobjPdf->Cell(45,6,utf8_decode("Centro asistencial: "),0,0,"L");
   $lobjPdf->SetFont("arial","",10);
   $lobjPdf->Cell(145,6,utf8_decode($laconsulta['nombrecentroasistencial']),'B',1,"L");
   $lobjPdf->SetFont("arial","B",10);
